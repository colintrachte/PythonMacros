...
{
    // Populate the global elements object instead of redeclaring it locally
    elements = {
    ...
    if (elements.resizeHandle && elements.consoleToolbar)
    {
        elements.resizeHandle.onmousedown = () =>
        {
            document.onmousemove = (e) =>
            {
                const h = window.innerHeight - e.clientY;
                if (h > 50 && h < 400) elements.consoleToolbar.style.height = `${h}px`;
            };
